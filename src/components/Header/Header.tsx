...
import { ClickedProps } from "../../types/others";

const HamburgerBtn = styled.button<ClickedProps>`
  display: none;
...
const MobileMenu = styled.nav<ClickedProps>`
  display: none;
  @media only Screen and (max-width: 48em) {
    display: flex;
  }
      ...
      <div className="container-md">
        <div className="header__inner">
          ...
          <div className="header__nav-actions">
            <a className="header__nav-phone" href="tel:+12403751288">
              +1 (240) 375-1288
            </a>
          </div>
