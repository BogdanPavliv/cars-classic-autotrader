...
const SectionMap: React.FC = () => {
  ...
  const emptyNameHandler = (e: InputEvent) => {
  ...
  const emptySurnameHandler = (e: InputEvent) => {
  ...
  return (
    <>
      <section className={`${styles.section_map} page-contacts`}>
        <div className="container-md">
          <div className={styles.section_map__wrapper}>
            <div
              className={`${styles.section_map__top} ${styles.map_top_margin}`}
            >
              ...
              <div className={styles.section_map__top__actions}>
                <a
                  className={styles.section_map__top__phone}
                  href="tel:+17015811331"
                >
                  +1 (701) 581-1331
                </a>
                <a
                  className={styles.section_map__top__address}
            ...
            <div className={styles.section_map__bottom}>
              <div className={styles.section_map__map_wrapper}>
                <div style={{ width: "100%" }}>
                  <iframe
      ...
      >
        ...
        <form action="#!" id="form" className="form" onSubmit={handleSubmit}>
          <div className="form__top">
            ...
            <input
              onChange={(e) => emptySurnameHandler(e)}
              value={emptySurname}
              onBlur={(e) => blurHandler(e)}
              className={
                emptySurnameDirty && emptySurnameError
                  ? "form__input form__input--error"
                  : "form__input"
              }
              id="formSurname"
