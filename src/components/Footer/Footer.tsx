        ...
        <div className="footer__wrapper">
          <div className="footer__top">
            <div className="footer__logo--wrapper">
              ...
              <a className="privacy hiden-element" href="#!">
                Privacy Policies
              </a>
            </div>
            <div className="footer__menu">
              <ul className="footer__menu--list">
                ...
                <li className="footer__menu--item">
                  <NavLink to="/cars" className="footer__menu--link">
                    Cars
                  </NavLink>
                </li>
                <li className="footer__menu--item">
                ...
                <li className="footer__menu--item">
                  <NavLink to="/services" className="footer__menu--link">
                    Services
                  </NavLink>
                </li>
                <li className="footer__menu--item">
            ...
            <div className="footer__actions">
              <a className="footer__actions--phone" href="tel:+17015811331">
                +1&nbsp;(701) 581-1331
              </a>
              <a
                className="footer__actions--address"
              ...
              <a className="privacy hiden-element visible" href="#!">
                Privacy Policies
              </a>
            </div>
          </div>
          <div className="footer__bottom">
            <div className="footer__bottom--copy">
              <p className="footer__bottom--copy-text">
